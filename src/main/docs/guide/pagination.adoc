...
[source,groovy]
.grails-app/controller/using/hal/json/with/json/views/UrlMappings.groovy
----
include::{sourceDir}/grails-app/controllers/using/hal/json/with/json/views/UrlMappings.groovy[indent=0,tag=urlMappingsWithResources]
----
